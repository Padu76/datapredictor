...
export default function Home(){
  ...
  return (
    <>
      ...
      {/* FORMATS con gradient border cards */}
      <section className="section">
        <div className="container">
          ...
          {rawRes && (
            <>
              ...
              <section className="advisor" style={{marginTop:16}}>
                <h3>Advisor Pro</h3>
                <button className="primary" onClick={generateAdvisor} disabled={advisorLoading || !rawRes}>{advisorLoading ? 'Generazione...' : 'Genera report consulente'}</button>
                {advisorData && (
                  <>
